...
switch ($type) {
  case $NAME_XSS:
    ...
    break;
  case $NAME_HTTP_HEADER:
    $HELP = $HELP_HTTP_HEADER;
    $FUNCS = [];
    break;
  case $NAME_SESSION_FIXATION:
    $HELP = $HELP_SESSION_FIXATION;
    $FUNCS = [];
    break;
  case $NAME_CODE:
    $HELP = $HELP_CODE;
    ...
    break;
  case $NAME_REFLECTION:
    $HELP = $HELP_REFLECTION;
    $FUNCS = [];
    break;
  case $NAME_FILE_INCLUDE:
    $HELP = $HELP_FILE_INCLUDE;
  ...
  case $NAME_FILE_READ:
    ...
    $FUNCS = $F_SECURING_FILE;
    break;
  case $NAME_FILE_AFFECT:
    $HELP = $HELP_FILE_AFFECT;
    $FUNCS = $F_SECURING_FILE;
    break;
  case $NAME_EXEC:
    $HELP = $HELP_EXEC;
...
<div style="padding-left:30px;padding-right:30px">
  ...
  <p><?php if (!empty($HELP['link'])) {
      echo "More information about $type can be found <a href=\"{$HELP['link']}\" target=\"_blank\">here</a>.";
    } ?></p>
